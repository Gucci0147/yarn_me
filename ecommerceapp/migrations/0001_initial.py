# Generated by Django 3.2.1 on 2024-08-31 10:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(choices=[('USD', 'Dollar'), ('EUR', 'Euro'), ('NGN', 'Naira'), ('CAD', 'Canadian Dollar'), ('AUD', 'Australian Dollar')], default='NGN', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtotal', models.PositiveIntegerField()),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cartproducts', to='ecommerceapp.cart')),
